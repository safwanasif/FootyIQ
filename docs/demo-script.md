...
Recording: [silent automated walkthrough](media/footyiq-demo.webm), generated by the passing [release CI run](https://github.com/safwanasif/FootyIQ/actions/runs/36206042342). It uses real isolated CI services and presentation pauses after verified results. It is not a narrated recording of production; the script above remains available for a personal presentation.
